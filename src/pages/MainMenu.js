          ...
          <>
            <div className="py-26 lg:pl-12 bg-white w-full">
              <div class=" my-12">
                ...
                {/* </a> */}
                <h2 class="text-3xl md:text-2xl font-medium mb-2">Main Menu</h2>
              <p>Click  on the link on the left hand side to continue</p>
              </div>
              ...
              <div className=" flex justify-center">
                <div className="lg:flex max-w-4xl lg:w-2/3 w-screen justify-between mt-10 lg:max-h-96 max-h-52    border-2 rounded-md border-fountain ">
                  {/* <!-- component --> */}
                  <section class="   w-full">
                    <div class="container  w-full  ">
                      <div class=" w-full hidden lg:block ">
                        <h1 className="text-center font-bold py-6 text-xl">
                  ...
                  <div class="  block lg:hidden   w-full ">
                    <h1 className="text-center font-bold text-sm py-4">
                      Teacher's Information
                    </h1>
                    <div className="border-b-2  max-w-full   w-full border-fountain"></div>
                    <div className=" px-4 py-4 flex flex-col h-40 justify-between">
                      <p className="text-lg">
                        <span className="font-bold text-md">Full Name</span> : Kakashi
                        Hatake WhiteFang
                      </p>
                      <p className="text-lg">
                        <span className="font-bold">E-Mail</span> :
