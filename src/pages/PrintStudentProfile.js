        ...
        <div className="py-26 lg:pl-12 bg-white w-full">
          <div className=" lg:flex justify-between">
            <div class=" mt-10 mb-12">
              ...
              <h2 class="text-3xl md:text-2xl font-medium mb-2">Student Profile</h2>
            </div>
          </div>
          ...
          <div className="lg:flex justify-between w-full">
            ...
            <div className="max-w-lg lg:w-1/3 w-full  p-8 h-96 mt-5  border-fountain  text-center text-fountain border-2 mx-auto rounded-lg dark:bg-gray-900 dark:text-gray-100"></div>
          </div>
        </div>
      </div>
    </div>
