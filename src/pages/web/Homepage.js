          ...
          <Navbar/>
            ...
            <section>
                <div className=" pl-9 py-4">
                  ...
                  <div className="flex justify-center">
                      <button class=" rounded-full bg-enroll text-white px-4 py-1">ENROLL NOW</button>
                  </div> 
                </div>  
            </section>
                ...
                <div className=" bg-welcome py-4">
                    <div className=" pl-9">
                        <div>
                            ...
                            <p className=" w-96">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eu dis quis at dui tincidunt risus nisi ligula consequat. Velit amet blandit amet est massa dui. Dictum dictumst tortor fusce risus diam. At diam posuere sit fringilla. Porttitor porttitor pellentesque maecenas amet, aliquet diam dolor. Aliquam blandit commodo ullamcorper sed est. Egestas lacinia purus nunc, gravida odio a nunc pellentesque senectus. Convallis mi aenean in morbi consectetur donec ac mattis. Laoreet vestibulum rhoncus adipiscing commodo viverra parturient sed amet.</p>
                        </div>
                        <button class=" rounded-full bg-button text-white px-4 py-1">READ MORE</button>
                    </div> 
                </div>
            </section>
            ...
            <section className="  container mb-20">
                <div className="">
                    <div>
                        <h2 className=" text-3xl font-bold text-gray-800 dark:text-gray-100 my-8">OUR SERVICES</h2>
                    <   div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                            <div className=" container flex-1 overflow-hidden shadow-sm relative bg-creche h-80 " >
                                <p className=" justify-center text-3xl font-bold text-white dark:text-gray-100">CRECHE</p>
                            </div>
                            <div className="container flex-1 overflow-hidden shadow-sm relative bg-Nursery h-72">
                                <p className=" text-3xl font-bold text-white dark:text-gray-100">NURSERY</p>
                            </div>
                            <div className="container flex-1 overflow-hidden shadow-sm relative bg-Primary h-64">
                                <p className=" text-3xl font-bold text-white dark:text-gray-100">PRIMARY</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section className=" container mt-10  bg-statements" >
                <div className=" py-20">
                    <div className=" ml-16 mt-11 space-x-8">
                        <a className="text-2xl font-bold text-gray-800 dark:text-gray-100 " href="">OUR VISION</a>
                        <a className="text-2xl font-bold text-gray-800 dark:text-gray-100 " href="">OUR MISSION</a>
                        <a className="text-2xl font-bold text-gray-800 dark:text-gray-100 " href="">CORE VALUES</a>
                    </div>
                    <div className=" mt-10" >
                    <div class="  flex justify-evenly">
                        <div class="flex items-center justify-center lg:justify-start">
                            <div class="max-w-lg">
                              <img
                                ...
                                src= "./books.jpg" className=" w-96 h-72 pt-1" 
                                alt=""
                              />
                            </div>
                        </div>
                        <div class=" mt-9 ml-8 lg:w-1/2">
                            ...
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ultrices duis nisl 
                            elementum aliquet lectus massa, mauris scelerisque. Quis lacinia proin nec 
                            adipiscing donec. Velit massa tristique sed leo enim eu pharetra turpis. Odio 
                            turpis pretium ipsum dis ut curabitur ornare non sit.
                            </p>
                        </div>
                    </div>
                    </div>
            ...
            <section className="  container my-8">
              <h2 className=" text-3xl font-bold text-gray-800 dark:text-gray-100 mb-10">SCHOOL LEADERS</h2>
                <div className="grid justify-center grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <img
                        ...
                        src= "./headmaster.jpg" className=" w-96 h-72 pt-1" 
                        alt=""
                      />
                    ...
                    <img
                        class="object-cover object-center w-full h-64 rounded-md "
                        src= "./secretary.jpg" className=" w-96 h-72 pt-1" 
                        alt=""
                      />
                    ...
                    <img
                        class="object-cover object-center w-full h-64 rounded-md "
                        src= "./headteacher.jpg" className=" w-96 h-72 pt-1" 
                        alt=""
                      />
            ...
            <section className="my-8  bg-testimonies">
