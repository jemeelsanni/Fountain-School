...
const LogoutHandler = () => {
  ...
  return (
    <div className="">
      <button onClick={modalFunc} className="  ">
        Logout
      </button>
      {modal && (
        <div className="">
...
//         {show && (
//           <div
//             className="py-12 mt-96 z-10 bg-gray-700 dark:bg-gray-900 transition duration-150 ease-in-out  absolute top-0 right-0 bottom-0 left-0"
//             id="modal"
//           >
//             <div role="alert" className="container  mx-auto  md:w-2/3 max-w-lg">
//               <div className="relative py-8 px-8 md:px-16 w-full  dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400">
...
//           <button
//             className="focus:outline-none mx-auto transition duration-150 ease-in-out hover:bg-indigo-600 bg-fountain rounded text-white relative px-4 sm:px-8 py-2 text-xs sm:text-sm"
//             onClick={() => setShow(!show)}
//           >
//             Open Modal
//           </button>
