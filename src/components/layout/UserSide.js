...
const Dashboard = () => {
  ...
  return (
    <aside className="ml-[-100%] hidden lg:block pl-9 top-0 pb-3 px-6 w-1/4 flex flex-col justify-between border-r-2 border-fountain  bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%] ">
      <div>
