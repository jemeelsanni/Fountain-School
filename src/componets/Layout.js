  ...
  return (
    <div>
      <div className=" bg-white px-9">
        <nav className="2xl:container 2xl:mx-auto py-3 border-b-4 border-fountain  mt-5 ">
          ...
          >
            ...
            <ul className="space-y-4 tracking-wide mt-2">
                ...
                <li>
                    <a href="#" className="px-4 py-5 flex items-center border-b-2 space-x-4 text-gray-900 group">
                ...
                <li>
                    <a href="#" className="px-4 py-5 flex items-center border-b-2 space-x-4 text-gray-900 group">
                        ...
                        <span className="group-hover:text-gray-700">FAQ/Helpdesk</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" className="px-4 py-5 flex items-center border-b-2 space-x-4 text-gray-900 group">
                        ...
                        <span className="group-hover:text-gray-700">Teacher's Login</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" className="px-4 py-5 flex items-center border-b-2 space-x-4 text-gray-900 group">
                        ...
                        <span className="group-hover:text-gray-700">Student's Login</span>
                    </a>
                </li>
    
                <li>
                    <a href="#" className="px-4 py-5 flex items-center space-x-4 text-gray-900 group">
